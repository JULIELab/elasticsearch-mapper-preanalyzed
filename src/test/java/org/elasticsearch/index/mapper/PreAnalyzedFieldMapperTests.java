...
//      this shows the serialized PreanalyzedFieldMapper to check how it looks with doXContentBody commented out.
//        try (final ByteArrayOutputStream bos = new ByteArrayOutputStream()) {
//            try (XContentBuilder builder = XContentFactory.contentBuilder(XContentType.JSON, bos)) {
//                final Mapper field = docMapper.mappers().getMapper("field");
//                builder.startObject();
